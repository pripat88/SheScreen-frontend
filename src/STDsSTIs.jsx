...
export default function STDsSTIsInfoPage() {
    return (
        <div className="info-page">
            ...
            <h2>Symptoms</h2>
            <p>
                Some common symptoms of STDs/STIs include...
            </p>

            <h2>Prevention</h2>
            <p>
                Ways to prevent STDs/STIs include...
            </p>

            <h2>Treatment</h2>
            <p>
                Treatment options for STDs/STIs include...
            </p>
        </div>
    );
}
